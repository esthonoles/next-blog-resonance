        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-foreground leading-tight mb-6">
              Writing That{" "}
              <span className="text-primary italic ">Resonotes</span>
            </h1>
          ...
          >
            <div className="relative ">
              <div className="h-80 w-80 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full blur-3xl absolute -top-10 -right-10"></div>
              <div className="w-96 h-96 bg-gradien-to-tl from-secondary/30 to-primary/30 rounded-2xl transform rotate-6 shadow-2xl"></div>
            </div>
          </motion.div>
        </div>
      </div>
